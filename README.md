...
- **People lens** — macOS Vision detects faces (group photos included) and they're clustered into people you can **name** and browse; a face grid on the right, a people list on the left. Recognition is best-effort (Vision feature-print embeddings, no bundled model), fully offline.
